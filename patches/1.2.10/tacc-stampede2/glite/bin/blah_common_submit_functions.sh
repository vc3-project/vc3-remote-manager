...
function bls_add_job_wrapper ()
{
  ...
  echo "export \"X509_USER_PROXY=${bls_proxy_local_file}\"">>$bls_tmp_file
  ...
  echo "echo \"bls_opt_run_dir = \$bls_opt_run_dir\""
  echo "echo \"bls_tmp_name = \$bls_tmp_name\""
  echo "echo \"blah_wn_temporary_home_dir = \$blah_wn_temporary_home_dir\""
